  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (formData.email.trim() && formData.email.trim() !== '-') {
        ...
        const formattedBriefingDateEmail = ad.briefingDate ? `${formatAbbreviatedDate(ad.briefingDate)} (${indonesianDayName(ad.briefingDate).toUpperCase()})` : 'Seperti diiklankan';
